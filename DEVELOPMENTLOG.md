...
In 24.01 we accidentally introduced a bug that causes some crashes when loading save games on Windows machines. This one was tricky to spot in testing since it only occured on Windows, and only in release builds, which are not often used when testing in development. This is fixed in 24.01.1.
