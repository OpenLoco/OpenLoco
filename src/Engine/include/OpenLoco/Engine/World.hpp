...
namespace OpenLoco::World
{
    ...
    {
        return TilePos2{ static_cast<tile_coord_t>(coords.x / World::kTileSize), static_cast<tile_coord_t>(coords.y / World::kTileSize) };
    }
    ...
    {
        return Pos2{ static_cast<coord_t>(coords.x * World::kTileSize), static_cast<coord_t>(coords.y * World::kTileSize) };
    }
}
