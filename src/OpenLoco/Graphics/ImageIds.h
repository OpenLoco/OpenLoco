...
namespace OpenLoco::ImageIds
{
    ...
    constexpr uint32_t spark_00 = 3421;
    constexpr uint32_t spark_01 = 3422;
    constexpr uint32_t spark_02 = 3423;
    constexpr uint32_t spark_03 = 3424;
    constexpr uint32_t spark_04 = 3425;
    constexpr uint32_t spark_05 = 3426;
    constexpr uint32_t spark_06 = 3427;
    constexpr uint32_t spark_07 = 3428;
    constexpr uint32_t spark_08 = 3429;
    constexpr uint32_t spark_09 = 3430;
    constexpr uint32_t spark_10 = 3431;
    constexpr uint32_t spark_11 = 3432;
    constexpr uint32_t spark_12 = 3433;
    constexpr uint32_t spark_13 = 3434;
    constexpr uint32_t spark_14 = 3435;
    constexpr uint32_t spark_15 = 3436;
    constexpr uint32_t spark_16 = 3437;
    constexpr uint32_t spark_17 = 3438;
    constexpr uint32_t spark_18 = 3439;
    constexpr uint32_t spark_19 = 3440;
    constexpr uint32_t spark_20 = 3441;
    constexpr uint32_t spark_21 = 3442;
    constexpr uint32_t spark_22 = 3443;
    constexpr uint32_t spark_23 = 3444;
    constexpr uint32_t spark_24 = 3445;
