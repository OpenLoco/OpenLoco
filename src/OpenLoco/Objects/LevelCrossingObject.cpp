...
{
    // 0x00478156
    void LevelCrossingObject::drawPreviewImage(Gfx::Context& dpi, const int16_t x, const int16_t y) const
    {
    ...
    // 0x004781A4
    void LevelCrossingObject::drawDescription(Gfx::Context& dpi, const int16_t x, const int16_t y, [[maybe_unused]] const int16_t width) const
    {
