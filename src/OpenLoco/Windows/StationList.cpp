...
namespace OpenLoco::Ui::Windows::StationList
{
    ...
    static Widget _widgets[] = {
        ...
        makeWidget({ 585, 2 }, { 13, 13 }, WidgetType::tooltip, WindowColour::primary, ImageIds::close_button, StringIds::tooltip_close_window),
        ...
        makeWidget({ 4, 43 }, { 200, 12 }, WidgetType::button_grid_sort, WindowColour::secondary, StringIds::null, StringIds::tooltip_sort_by_name),
        makeWidget({ 204, 43 }, { 200, 12 }, WidgetType::button_grid_sort, WindowColour::secondary, StringIds::null, StringIds::tooltip_sort_by_station_status),
        makeWidget({ 404, 43 }, { 90, 12 }, WidgetType::button_grid_sort, WindowColour::secondary, StringIds::null, StringIds::tooltip_sort_by_total_units_waiting),
        makeWidget({ 494, 43 }, { 120, 12 }, WidgetType::button_grid_sort, WindowColour::secondary, StringIds::null, StringIds::tooltip_sort_by_cargo_accepted),
