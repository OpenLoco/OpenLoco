...
namespace OpenLoco::Ui::Windows::StationList
{
    ...
    static Widget _widgets[] = {
        makeWidget({ 0, 0 }, { 600, 197 }, WidgetType::frame, ColourIndex::primary),
        makeWidget({ 1, 1 }, { 598, 13 }, WidgetType::caption_24, ColourIndex::primary, StringIds::stringid_all_stations),
        makeWidget({ 585, 2 }, { 13, 13 }, WidgetType::wt_9, ColourIndex::primary, ImageIds::close_button, StringIds::tooltip_close_window),
        makeWidget({ 0, 41 }, { 600, 155 }, WidgetType::panel, ColourIndex::secondary),
        makeRemapWidget({ 3, 15 }, { 31, 27 }, WidgetType::wt_8, ColourIndex::secondary, ImageIds::tab, StringIds::tooltip_all_stations),
        makeRemapWidget({ 3, 15 }, { 31, 27 }, WidgetType::wt_8, ColourIndex::secondary, ImageIds::tab, StringIds::tooltip_rail_stations),
        makeRemapWidget({ 3, 15 }, { 31, 27 }, WidgetType::wt_8, ColourIndex::secondary, ImageIds::tab, StringIds::tooltip_road_stations),
        makeRemapWidget({ 3, 15 }, { 31, 27 }, WidgetType::wt_8, ColourIndex::secondary, ImageIds::tab, StringIds::tooltip_airports),
        makeRemapWidget({ 3, 15 }, { 31, 27 }, WidgetType::wt_8, ColourIndex::secondary, ImageIds::tab, StringIds::tooltip_ship_ports),
        makeWidget({ 0, 14 }, { 26, 26 }, WidgetType::wt_9, ColourIndex::primary, StringIds::null, StringIds::tooltip_select_company),
        makeWidget({ 4, 43 }, { 200, 12 }, WidgetType::wt_14, ColourIndex::secondary, StringIds::null, StringIds::tooltip_sort_by_name),
        makeWidget({ 204, 43 }, { 200, 12 }, WidgetType::wt_14, ColourIndex::secondary, StringIds::null, StringIds::tooltip_sort_by_station_status),
        makeWidget({ 404, 43 }, { 90, 12 }, WidgetType::wt_14, ColourIndex::secondary, StringIds::null, StringIds::tooltip_sort_by_total_units_waiting),
        makeWidget({ 494, 43 }, { 120, 12 }, WidgetType::wt_14, ColourIndex::secondary, StringIds::null, StringIds::tooltip_sort_by_cargo_accepted),
        makeWidget({ 3, 56 }, { 594, 126 }, WidgetType::scrollview, ColourIndex::secondary, Scrollbars::vertical),
        widgetEnd(),
    };
