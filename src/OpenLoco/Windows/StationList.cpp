...
namespace OpenLoco::Ui::Windows::StationList
{
    ...
    static Widget _widgets[] = {
        ...
        makeWidget({ 4, 43 }, { 200, 12 }, WidgetType::buttonGridSort, WindowColour::secondary, StringIds::null, StringIds::tooltip_sort_by_name),
        makeWidget({ 204, 43 }, { 200, 12 }, WidgetType::buttonGridSort, WindowColour::secondary, StringIds::null, StringIds::tooltip_sort_by_station_status),
        makeWidget({ 404, 43 }, { 90, 12 }, WidgetType::buttonGridSort, WindowColour::secondary, StringIds::null, StringIds::tooltip_sort_by_total_units_waiting),
        makeWidget({ 494, 43 }, { 120, 12 }, WidgetType::buttonGridSort, WindowColour::secondary, StringIds::null, StringIds::tooltip_sort_by_cargo_accepted),
