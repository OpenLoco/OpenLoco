...
#define commonWidgets(frameWidth, frameHeight, frameType)                                                                                                \
    makeWidget({ 0, 0 }, { frameWidth, frameHeight }, frameType, ColourIndex::primary),                                                                  \
        ...
        makeWidget({ 2, frameHeight - 73 }, { 168, 64 }, WidgetType::viewport, ColourIndex::primary, 0xFFFFFFFE),                                        \
        makeWidget({ 180, frameHeight - 73 }, { 168, 64 }, WidgetType::viewport, ColourIndex::primary, 0xFFFFFFFE),                                      \
        makeWidget({ 2, frameHeight - 75 }, { 180, 75 }, WidgetType::wt_9, ColourIndex::primary),                                                        \
        makeWidget({ 2, frameHeight - 75 }, { 180, 75 }, WidgetType::wt_9, ColourIndex::primary)
