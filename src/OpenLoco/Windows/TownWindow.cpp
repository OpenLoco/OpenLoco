...
#define commonWidgets(frameWidth, frameHeight, windowCaptionId)                                                                                                        \
    ...
    namespace Town
    {
        ...
        static Widget widgets[] = {
            ...
            makeWidget({ 198, 44 }, { 24, 24 }, WidgetType::button_with_image, WindowColour::secondary, ImageIds::town_expand, StringIds::expand_this_town),
            makeWidget({ 198, 68 }, { 24, 24 }, WidgetType::button_with_image, WindowColour::secondary, ImageIds::rubbish_bin, StringIds::demolish_this_town),
            widgetEnd(),
        };
        ...
        static void prepareDraw(Window* self)
        {
            ...
            {
                self->widgets[widx::expand_town].type = WidgetType::button_with_image;
                self->widgets[widx::demolish_town].type = WidgetType::button_with_image;
            }
            else
            {
