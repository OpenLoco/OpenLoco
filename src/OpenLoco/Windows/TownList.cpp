...
#define commonWidgets(frameWidth, frameHeight, windowCaptionId)                                                                                                        \
    ...
    namespace BuildBuildings
    {
        ...
        Widget widgets[] = {
            ...
            makeWidget({ 575, 46 }, { 24, 24 }, WidgetType::button_with_image, WindowColour::secondary, ImageIds::rotate_object, StringIds::rotate_object_90),
            makeWidget({ 579, 91 }, { 16, 16 }, WidgetType::button_with_colour, WindowColour::secondary, ImageIds::null, StringIds::tooltip_object_colour),
            widgetEnd(),
        };
