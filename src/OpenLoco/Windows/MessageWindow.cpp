...
#define commonWidgets(frameWidth, frameHeight, windowCaptionId)                                                                                                      \
    ...
    namespace Settings
    {
        ...
        Widget widgets[] = {
            ...
            makeWidget({ 348, 48 }, { 11, 10 }, WidgetType::button, WindowColour::secondary, StringIds::combobox),
            makeWidget({ 236, 62 }, { 124, 12 }, WidgetType::combobox, WindowColour::secondary),
            makeWidget({ 348, 63 }, { 11, 10 }, WidgetType::button, WindowColour::secondary, StringIds::combobox),
            makeWidget({ 236, 77 }, { 124, 12 }, WidgetType::combobox, WindowColour::secondary),
            makeWidget({ 348, 78 }, { 11, 10 }, WidgetType::button, WindowColour::secondary, StringIds::combobox),
            makeWidget({ 236, 92 }, { 124, 12 }, WidgetType::combobox, WindowColour::secondary),
            makeWidget({ 348, 93 }, { 11, 10 }, WidgetType::button, WindowColour::secondary, StringIds::combobox),
            makeWidget({ 236, 107 }, { 124, 12 }, WidgetType::combobox, WindowColour::secondary),
            makeWidget({ 348, 108 }, { 11, 10 }, WidgetType::button, WindowColour::secondary, StringIds::combobox),
            makeWidget({ 236, 122 }, { 124, 12 }, WidgetType::combobox, WindowColour::secondary),
            makeWidget({ 348, 123 }, { 11, 10 }, WidgetType::button, WindowColour::secondary, StringIds::combobox),
            widgetEnd(),
        };
