...
namespace OpenLoco::Ui::Windows::VehicleList
{
    ...
    Widget _widgets[] = {
        ...
        makeWidget({ 4, 43 }, { 310, 12 }, WidgetType::buttonGridSort, WindowColour::secondary, StringIds::null, StringIds::tooltip_sort_by_name),
        makeWidget({ 314, 43 }, { 100, 12 }, WidgetType::buttonGridSort, WindowColour::secondary, StringIds::null, StringIds::tooltip_sort_by_profit),
