...
namespace OpenLoco::Ui::Windows::VehicleList
{
    ...
    Widget _widgets[] = {
        ...
        makeWidget({ 0, 14 }, { 26, 26 }, WidgetType::buttonWithImage, WindowColour::primary, Widget::contentNull, StringIds::tooltip_select_company),
        makeWidget({ 4, 43 }, { 310, 12 }, WidgetType::buttonTableHeader, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_sort_by_name),
        makeWidget({ 314, 43 }, { 100, 12 }, WidgetType::buttonTableHeader, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_sort_by_profit),
        makeWidget({ 414, 43 }, { 65, 12 }, WidgetType::buttonTableHeader, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_sort_by_age),
        makeWidget({ 479, 43 }, { 67, 12 }, WidgetType::buttonTableHeader, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_sort_by_reliability),
