...
namespace OpenLoco::Ui::Windows::TitleMenu
{
    ...
    static Widget _widgets[] = {
        makeWidget({ 0, 0 }, { btn_main_size, btn_main_size }, WidgetType::button_with_image, WindowColour::secondary, StringIds::null, StringIds::title_menu_new_game),
        makeWidget({ btn_main_size, 0 }, { btn_main_size, btn_main_size }, WidgetType::button_with_image, WindowColour::secondary, StringIds::null, StringIds::title_menu_load_game),
        makeWidget({ btn_main_size * 2, 0 }, { btn_main_size, btn_main_size }, WidgetType::button_with_image, WindowColour::secondary, StringIds::null, StringIds::title_menu_show_tutorial),
        makeWidget({ btn_main_size * 3, 0 }, { btn_main_size, btn_main_size }, WidgetType::button_with_image, WindowColour::secondary, StringIds::null, StringIds::title_menu_scenario_editor),
        makeWidget({ btn_main_size * 4 - 31, btn_main_size - 27 }, { 31, 27 }, WidgetType::button_with_image, WindowColour::secondary, StringIds::null, StringIds::title_menu_chat_tooltip),
    ...
    static void prepareDraw(Ui::Window* window)
    {
        ...
        window->widgets[Widx::tutorial_btn].type = Ui::WidgetType::button_with_image;
        window->widgets[Widx::scenario_editor_btn].type = Ui::WidgetType::button_with_image;
        ...
        if (OpenLoco::isNetworked())
        {
            ...
            window->widgets[Widx::chat_btn].type = Ui::WidgetType::button_with_image;
