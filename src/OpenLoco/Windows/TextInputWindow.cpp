...
namespace OpenLoco::Ui::Windows::TextInput
{
    ...
    static void draw(Ui::Window* window, Gfx::Context* context)
    {
        ...
        *((string_id*)(&_commonFormatArgs[0])) = _message;
        ...
        Gfx::drawStringCentredWrapped(*context, position, window->width - 8, Colour2::black, StringIds::wcolour2_stringid, &_commonFormatArgs[0]);
        ...
        *((string_id*)(&_commonFormatArgs[0])) = StringIds::buffer_2039;
        ...
        Gfx::drawString_494B3F(*clipped, &position, Colour2::black, StringIds::black_stringid, _commonFormatArgs);
