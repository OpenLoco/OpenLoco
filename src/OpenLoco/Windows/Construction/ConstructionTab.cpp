...
namespace OpenLoco::Ui::Windows::Construction::Construction
{
    ...
    Widget widgets[] = {
        ...
        makeWidget({ 3, 45 }, { 22, 24 }, WidgetType::button_with_image, WindowColour::secondary, ImageIds::construction_left_hand_curve_very_small, StringIds::tooltip_left_hand_curve_very_small),
        makeWidget({ 3, 45 }, { 22, 24 }, WidgetType::button_with_image, WindowColour::secondary, ImageIds::construction_left_hand_curve_small, StringIds::tooltip_left_hand_curve_small),
        makeWidget({ 25, 45 }, { 22, 24 }, WidgetType::button_with_image, WindowColour::secondary, ImageIds::construction_left_hand_curve, StringIds::tooltip_left_hand_curve),
        makeWidget({ 47, 45 }, { 22, 24 }, WidgetType::button_with_image, WindowColour::secondary, ImageIds::construction_left_hand_curve_large, StringIds::tooltip_left_hand_curve_large),
        makeWidget({ 69, 45 }, { 22, 24 }, WidgetType::button_with_image, WindowColour::secondary, ImageIds::construction_right_hand_curve_large, StringIds::tooltip_right_hand_curve_large),
        makeWidget({ 91, 45 }, { 22, 24 }, WidgetType::button_with_image, WindowColour::secondary, ImageIds::construction_right_hand_curve, StringIds::tooltip_right_hand_curve),
        makeWidget({ 113, 45 }, { 22, 24 }, WidgetType::button_with_image, WindowColour::secondary, ImageIds::construction_right_hand_curve_small, StringIds::tooltip_right_hand_curve_small),
        makeWidget({ 113, 45 }, { 22, 24 }, WidgetType::button_with_image, WindowColour::secondary, ImageIds::construction_right_hand_curve_very_small, StringIds::tooltip_right_hand_curve_very_small),
        makeWidget({ 9, 69 }, { 24, 24 }, WidgetType::button_with_image, WindowColour::secondary, ImageIds::construction_s_bend_dual_track_left, StringIds::tooltip_s_bend_left_dual_track),
        makeWidget({ 33, 69 }, { 24, 24 }, WidgetType::button_with_image, WindowColour::secondary, ImageIds::construction_s_bend_left, StringIds::tooltip_s_bend_left),
        makeWidget({ 57, 69 }, { 24, 24 }, WidgetType::button_with_image, WindowColour::secondary, ImageIds::construction_straight, StringIds::tooltip_straight),
        makeWidget({ 81, 69 }, { 24, 24 }, WidgetType::button_with_image, WindowColour::secondary, ImageIds::construction_s_bend_right, StringIds::tooltip_s_bend_right),
        makeWidget({ 105, 69 }, { 24, 24 }, WidgetType::button_with_image, WindowColour::secondary, ImageIds::construction_s_bend_dual_track_right, StringIds::tooltip_s_bend_right_dual_track),
        makeWidget({ 9, 96 }, { 24, 24 }, WidgetType::button_with_image, WindowColour::secondary, ImageIds::construction_steep_slope_down, StringIds::tooltip_steep_slope_down),
        makeWidget({ 33, 96 }, { 24, 24 }, WidgetType::button_with_image, WindowColour::secondary, ImageIds::construction_slope_down, StringIds::tooltip_slope_down),
        makeWidget({ 57, 96 }, { 24, 24 }, WidgetType::button_with_image, WindowColour::secondary, ImageIds::construction_level, StringIds::tooltip_level),
        makeWidget({ 81, 96 }, { 24, 24 }, WidgetType::button_with_image, WindowColour::secondary, ImageIds::construction_slope_up, StringIds::tooltip_slope_up),
        makeWidget({ 105, 96 }, { 24, 24 }, WidgetType::button_with_image, WindowColour::secondary, ImageIds::construction_steep_slope_up, StringIds::tooltip_steep_slope_up),
        ...
        makeWidget({ 6, 248 }, { 46, 24 }, WidgetType::button_with_image, WindowColour::secondary, ImageIds::construction_remove, StringIds::tooltip_remove),
        makeWidget({ 57, 248 }, { 24, 24 }, WidgetType::button_with_image, WindowColour::secondary, ImageIds::rotate_object, StringIds::rotate_90),
        widgetEnd(),
    };
    ...
    static void activateSelectedRoadWidgets(Window* window)
    {
        ...
        if (roadObj->road_pieces & RoadPieceFlags::track)
        {
            ...
            window->widgets[widx::left_hand_curve_very_small].type = WidgetType::button_with_image;
            window->widgets[widx::right_hand_curve_very_small].type = WidgetType::button_with_image;
        }

        if (roadObj->road_pieces & RoadPieceFlags::one_way)
        {
            window->widgets[widx::left_hand_curve_small].type = WidgetType::button_with_image;
            window->widgets[widx::right_hand_curve_small].type = WidgetType::button_with_image;
        }
        ...
        {
            window->widgets[widx::s_bend_dual_track_left].type = WidgetType::button_with_image;
        ...
        {
            window->widgets[widx::slope_down].type = WidgetType::button_with_image;
            window->widgets[widx::slope_up].type = WidgetType::button_with_image;
        }

        if (roadObj->road_pieces & RoadPieceFlags::steep_slope)
        {
            window->widgets[widx::steep_slope_down].type = WidgetType::button_with_image;
            window->widgets[widx::steep_slope_up].type = WidgetType::button_with_image;
        }
        ...
        window->widgets[widx::remove].type = WidgetType::button_with_image;
        ...
        if (_constructionHover == 1)
        {
            ...
            window->widgets[widx::rotate_90].type = WidgetType::button_with_image;
    ...
    static void activateSelectedTrackWidgets(Window* window)
    {
        ...
        window->widgets[widx::s_bend_left].type = WidgetType::button_with_image;
        window->widgets[widx::s_bend_right].type = WidgetType::button_with_image;
        window->widgets[widx::left_hand_curve_large].type = WidgetType::none;
        window->widgets[widx::right_hand_curve_large].type = WidgetType::none;
        window->widgets[widx::left_hand_curve].type = WidgetType::none;
        window->widgets[widx::right_hand_curve].type = WidgetType::none;
        ...
        {
            window->widgets[widx::left_hand_curve_large].type = WidgetType::button_with_image;
            window->widgets[widx::right_hand_curve_large].type = WidgetType::button_with_image;
        }

        if (trackObj->track_pieces & TrackPieceFlags::normal_curve)
        {
            window->widgets[widx::left_hand_curve].type = WidgetType::button_with_image;
            window->widgets[widx::right_hand_curve].type = WidgetType::button_with_image;
        }
        ...
        {
            window->widgets[widx::s_bend_dual_track_left].type = WidgetType::button_with_image;
            window->widgets[widx::s_bend_dual_track_right].type = WidgetType::button_with_image;
