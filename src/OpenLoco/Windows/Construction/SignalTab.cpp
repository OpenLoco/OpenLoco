...
namespace OpenLoco::Ui::Windows::Construction::Signal
{
    Widget widgets[] = {
        ...
        makeWidget({ 27, 110 }, { 40, 40 }, WidgetType::button_with_image, WindowColour::secondary, 0xFFFFFFFF, StringIds::tooltip_signal_both_directions),
        makeWidget({ 71, 110 }, { 40, 40 }, WidgetType::button_with_image, WindowColour::secondary, 0xFFFFFFFF, StringIds::tooltip_signal_single_direction),
        widgetEnd(),
    };
