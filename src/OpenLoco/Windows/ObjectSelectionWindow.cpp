...
#pragma pack(pop)
    ...
    Widget widgets[] = {
        makeWidget({ 0, 0 }, { 600, 398 }, WidgetType::frame, ColourIndex::primary),
        makeWidget({ 1, 1 }, { 598, 13 }, WidgetType::caption_25, ColourIndex::primary, StringIds::title_object_selection),
        makeWidget({ 585, 2 }, { 13, 13 }, WidgetType::wt_9, ColourIndex::primary, ImageIds::close_button, StringIds::tooltip_close_window),
        makeWidget({ 0, 65 }, { 600, 333 }, WidgetType::panel, ColourIndex::secondary),
        makeWidget({ 3, 15 }, { 589, 50 }, WidgetType::wt_5, ColourIndex::secondary),
        makeWidget({ 470, 20 }, { 122, 12 }, WidgetType::wt_11, ColourIndex::primary, StringIds::object_selection_advanced, StringIds::object_selection_advanced_tooltip),
        makeWidget({ 4, 68 }, { 288, 317 }, WidgetType::scrollview, ColourIndex::secondary, Scrollbars::vertical),
        makeWidget({ 391, 68 }, { 114, 114 }, WidgetType::wt_9, ColourIndex::secondary),
        widgetEnd(),
    };
