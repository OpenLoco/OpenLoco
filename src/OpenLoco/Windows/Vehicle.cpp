    ...
    namespace Common
    {
        ...
        static void renameVehicle(Window* self, WidgetIndex_t widgetIndex)
        {
            ...
            if (vehicle != nullptr)
            {
                ...
                TextInput::openTextInput(self, StringIds::title_name_vehicle, StringIds::prompt_enter_new_vehicle_name, vehicle->name, inputSize, widgetIndex, &vehicle->ordinalNumber);
            }
        }
