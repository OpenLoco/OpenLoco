...
#define commonWidgets(frameWidth, frameHeight, windowCaptionId)                                                                                                      \
    ...
    namespace Details
    {
        ...
        static Widget widgets[] = {
            ...
            makeWidget({ 240, 44 }, { 24, 24 }, WidgetType::tooltip, WindowColour::secondary, -1, StringIds::tooltip_build_new_vehicle_for),
            makeWidget({ 240, 68 }, { 24, 24 }, WidgetType::tooltip, WindowColour::secondary, -1, StringIds::tooltip_remove_from_track),
            makeWidget({ 240, 96 }, { 24, 24 }, WidgetType::tooltip, WindowColour::secondary, ImageIds::rubbish_bin, StringIds::tooltip_sell_or_drag_vehicle),
    ...
    namespace Cargo
    {
        ...
        static Widget widgets[] = {
            ...
            makeWidget({ 240, 44 }, { 24, 24 }, WidgetType::tooltip, WindowColour::secondary, ImageIds::refit_cargo_button, StringIds::refit_vehicle_tip),
    ...
    namespace Route
    {
        ...
        static Widget widgets[] = {
            ...
            makeWidget({ 240, 44 }, { 24, 24 }, WidgetType::tooltip, WindowColour::secondary, ImageIds::route_force_unload, StringIds::tooltip_route_insert_force_unload),
            makeWidget({ 240, 68 }, { 24, 24 }, WidgetType::tooltip, WindowColour::secondary, ImageIds::route_wait, StringIds::tooltip_route_insert_wait_full_cargo),
            makeWidget({ 240, 92 }, { 24, 24 }, WidgetType::tooltip, WindowColour::secondary, ImageIds::route_skip, StringIds::tooltip_route_skip_next_order),
            makeWidget({ 240, 116 }, { 24, 24 }, WidgetType::tooltip, WindowColour::secondary, ImageIds::route_delete, StringIds::tooltip_route_delete_order),
            makeWidget({ 240, 140 }, { 24, 12 }, WidgetType::tooltip, WindowColour::secondary, ImageIds::red_arrow_up, StringIds::tooltip_route_move_order_up),
            makeWidget({ 240, 152 }, { 24, 12 }, WidgetType::tooltip, WindowColour::secondary, ImageIds::red_arrow_down, StringIds::tooltip_route_move_order_down),
            widgetEnd(),
        };
    }
    ...
    namespace Main
    {
        ...
        static Widget widgets[] = {
            ...
            makeWidget({ 240, 44 }, { 24, 24 }, WidgetType::tooltip, WindowColour::secondary, ImageIds::red_flag, StringIds::tooltip_stop_start),
            makeWidget({ 240, 68 }, { 24, 24 }, WidgetType::tooltip, WindowColour::secondary, ImageIds::null, StringIds::tooltip_remove_from_track),
            makeWidget({ 240, 92 }, { 24, 24 }, WidgetType::tooltip, WindowColour::secondary, ImageIds::pass_signal, StringIds::tooltip_pass_signal_at_danger),
            makeWidget({ 240, 116 }, { 24, 24 }, WidgetType::tooltip, WindowColour::secondary, ImageIds::construction_right_turnaround, StringIds::tooltip_change_direction),
        ...
        static void prepareDraw(Window* const self)
        {
            ...
            self->widgets[widx::stopStart].type = WidgetType::tooltip;
            self->widgets[widx::pickup].type = WidgetType::tooltip;
            self->widgets[widx::passSignal].type = WidgetType::tooltip;
            self->widgets[widx::changeDirection].type = WidgetType::tooltip;
    ...
    namespace Details
    {
        ...
        static void prepareDraw(Window* self)
        {
            ...
            self->widgets[widx::buildNew].type = WidgetType::tooltip;
            self->widgets[widx::pickup].type = WidgetType::tooltip;
            self->widgets[widx::remove].type = WidgetType::tooltip;
    ...
    namespace Cargo
    {
        ...
        static void prepareDraw(Window* const self)
        {
            ...
            widgets[widx::refit].type = WidgetType::tooltip;
...
#pragma pack(pop)
        ...
        static void prepareDraw(Window* const self)
        {
            ...
            WidgetType type = head->owner == CompanyManager::getControllingId() ? WidgetType::tooltip : WidgetType::none;
