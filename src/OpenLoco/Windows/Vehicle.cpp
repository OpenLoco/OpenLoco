...
#define commonWidgets(frameWidth, frameHeight, windowCaptionId)                                                                                                      \
    ...
    namespace Details
    {
        ...
        static Widget widgets[] = {
            ...
            makeWidget({ 240, 44 }, { 24, 24 }, WidgetType::buttonWithImage, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_build_new_vehicle_for),
            makeWidget({ 240, 68 }, { 24, 24 }, WidgetType::buttonWithImage, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_remove_from_track),
