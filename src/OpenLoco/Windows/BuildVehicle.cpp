...
namespace OpenLoco::Ui::BuildVehicle
{
    ...
    static window* create(company_id_t company)
    {
        ...
        window->setVisible(widx::close_button, widx::tab_build_new_trains, widx::tab_build_new_buses, widx::tab_build_new_trucks, widx::tab_build_new_trams, widx::tab_build_new_aircraft, widx::tab_build_new_ships, widx::tab_track_type_0, widx::tab_track_type_1, widx::tab_track_type_2, widx::tab_track_type_3, widx::tab_track_type_4, widx::tab_track_type_5, widx::tab_track_type_6, widx::tab_track_type_7, widx::scrollview_vehicle_selection);
