...
namespace OpenLoco::Ui::Windows::BuildVehicle
{
    ...
    static Widget _widgets[] = {
        makeWidget({ 0, 0 }, { 380, 233 }, WidgetType::frame, ColourIndex::primary),
        makeWidget({ 1, 1 }, { 378, 13 }, WidgetType::caption_24, ColourIndex::primary),
        makeWidget({ 365, 2 }, { 13, 13 }, WidgetType::wt_9, ColourIndex::primary, ImageIds::close_button, StringIds::tooltip_close_window),
        makeWidget({ 0, 41 }, { 380, 192 }, WidgetType::panel, ColourIndex::secondary),
        makeRemapWidget({ 3, 15 }, { 31, 27 }, WidgetType::wt_8, ColourIndex::secondary, ImageIds::tab, StringIds::tooltip_build_new_train_vehicles),
        makeRemapWidget({ 3, 15 }, { 31, 27 }, WidgetType::wt_8, ColourIndex::secondary, ImageIds::tab, StringIds::tooltip_build_new_buses),
        makeRemapWidget({ 3, 15 }, { 31, 27 }, WidgetType::wt_8, ColourIndex::secondary, ImageIds::tab, StringIds::tooltip_build_new_trucks),
        makeRemapWidget({ 3, 15 }, { 31, 27 }, WidgetType::wt_8, ColourIndex::secondary, ImageIds::tab, StringIds::tooltip_build_new_trams),
        makeRemapWidget({ 3, 15 }, { 31, 27 }, WidgetType::wt_8, ColourIndex::secondary, ImageIds::tab, StringIds::tooltip_build_new_aircraft),
        makeRemapWidget({ 3, 15 }, { 31, 27 }, WidgetType::wt_8, ColourIndex::secondary, ImageIds::tab, StringIds::tooltip_build_new_ships),
        makeRemapWidget({ 5, 43 }, { 31, 27 }, WidgetType::wt_8, ColourIndex::secondary, ImageIds::tab, StringIds::tooltip_vehicles_for),
        makeRemapWidget({ 36, 43 }, { 31, 27 }, WidgetType::wt_8, ColourIndex::secondary, ImageIds::tab, StringIds::tooltip_vehicles_for),
        makeRemapWidget({ 67, 43 }, { 31, 27 }, WidgetType::wt_8, ColourIndex::secondary, ImageIds::tab, StringIds::tooltip_vehicles_for),
        makeRemapWidget({ 98, 43 }, { 31, 27 }, WidgetType::wt_8, ColourIndex::secondary, ImageIds::tab, StringIds::tooltip_vehicles_for),
        makeRemapWidget({ 129, 43 }, { 31, 27 }, WidgetType::wt_8, ColourIndex::secondary, ImageIds::tab, StringIds::tooltip_vehicles_for),
        makeRemapWidget({ 160, 43 }, { 31, 27 }, WidgetType::wt_8, ColourIndex::secondary, ImageIds::tab, StringIds::tooltip_vehicles_for),
        makeRemapWidget({ 191, 43 }, { 31, 27 }, WidgetType::wt_8, ColourIndex::secondary, ImageIds::tab, StringIds::tooltip_vehicles_for),
        makeRemapWidget({ 222, 43 }, { 31, 27 }, WidgetType::wt_8, ColourIndex::secondary, ImageIds::tab, StringIds::tooltip_vehicles_for),
        makeWidget({ 3, 72 }, { 374, 146 }, WidgetType::scrollview, ColourIndex::secondary, Scrollbars::vertical),
        makeWidget({ 250, 44 }, { 180, 66 }, WidgetType::scrollview, ColourIndex::secondary, Scrollbars::none),
        widgetEnd(),
    };
