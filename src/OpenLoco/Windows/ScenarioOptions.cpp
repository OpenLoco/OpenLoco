...
{
    static const Ui::UiSize challengeWindowSize = { 366, 197 };
    static const Ui::UiSize companiesWindowSize = { 366, 327 };
    static const Ui::UiSize otherWindowSize = { 366, 217 };
