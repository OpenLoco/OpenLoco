...
namespace OpenLoco::Ui::Windows::Error
{
    ...
    namespace Error
    {
        ...
        Widget widgets[] = {
            makeWidget({ 0, 0 }, { 200, 42 }, WidgetType::wt_3, ColourIndex::primary),
            widgetEnd(),
        };
    }
    ...
    namespace ErrorCompetitor
    {
        ...
        Widget widgets[] = {
            makeWidget({ 0, 0 }, { 250, 70 }, WidgetType::wt_3, ColourIndex::primary),
            makeWidget({ 3, 3 }, { 64, 64 }, WidgetType::wt_3, ColourIndex::secondary),
            widgetEnd(),
        };
    }
