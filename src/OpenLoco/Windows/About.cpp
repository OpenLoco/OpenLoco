...
namespace OpenLoco::Ui::About
{
    ...
    static void draw(Ui::window* const window, Gfx::drawpixelinfo_t* const dpi)
    {
        ...
        drawStringCentred(*dpi, x, y, Colour::black, StringIds::about_locomotion_69, nullptr);

        y += 10;
        drawStringCentred(*dpi, x, y, Colour::black, StringIds::about_locomotion_70, nullptr);

        // Chris Sawyer logo
        drawImage(dpi, window->x + 92, window->y + 52, ImageIds::chris_sawyer_logo_small);

        y += 79;
        drawStringCentred(*dpi, x, y, Colour::black, StringIds::about_locomotion_71, nullptr);

        y += 10;
        drawStringCentred(*dpi, x, y, Colour::black, StringIds::about_locomotion_72, nullptr);

        y += 10;
        drawStringCentred(*dpi, x, y, Colour::black, StringIds::about_locomotion_73, nullptr);

        y += 10;
        drawStringCentred(*dpi, x, y, Colour::black, StringIds::about_locomotion_74, nullptr);

        y += 13;
        drawStringCentred(*dpi, x, y, Colour::black, StringIds::about_locomotion_75, nullptr);

        y += 25;
        drawStringCentred(*dpi, x, y, Colour::black, StringIds::about_locomotion_76, nullptr);

        y += 10;
        drawStringCentred(*dpi, x, y, Colour::black, StringIds::about_locomotion_77, nullptr);

        // Licenced to Atari
        y += 25;
        drawStringCentred(*dpi, x, y, Colour::black, StringIds::licenced_to_atari_inc, nullptr);
    }
