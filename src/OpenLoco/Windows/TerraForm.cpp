...
#define commonWidgets(frameWidth, frameHeight, windowCaptionId)                                                                                          \
    makeWidget({ 0, 0 }, { frameWidth, frameHeight }, WidgetType::frame, ColourIndex::primary),                                                          \
        ...
        makeWidget({ 0, 41 }, { 130, 74 }, WidgetType::panel, ColourIndex::secondary),                                                                   \
        makeRemapWidget({ 3, 15 }, { 31, 27 }, WidgetType::wt_6, ColourIndex::secondary, ImageIds::tab, StringIds::tooltip_clear_land),                  \
        makeRemapWidget({ 3, 15 }, { 31, 27 }, WidgetType::wt_6, ColourIndex::secondary, ImageIds::tab, StringIds::tooltip_adjust_land),                 \
        makeRemapWidget({ 3, 15 }, { 31, 27 }, WidgetType::wt_6, ColourIndex::secondary, ImageIds::tab, StringIds::tooltip_adjust_water),                \
        makeRemapWidget({ 3, 15 }, { 31, 27 }, WidgetType::wt_6, ColourIndex::secondary, ImageIds::tab, StringIds::tooltip_plant_trees),                 \
        makeRemapWidget({ 3, 15 }, { 31, 27 }, WidgetType::wt_6, ColourIndex::secondary, ImageIds::tab, StringIds::tooltip_build_walls)
    ...
    namespace PlantTrees
    {
        ...
        Widget widgets[] = {
            ...
            makeWidget({ 3, 45 }, { 605, 101 }, WidgetType::scrollview, ColourIndex::secondary, Scrollbars::vertical),
            makeWidget({ 609, 46 }, { 24, 24 }, WidgetType::wt_9, ColourIndex::secondary, ImageIds::rotate_object, StringIds::rotate_object_90),
            makeWidget({ 609, 70 }, { 24, 24 }, WidgetType::wt_10, ColourIndex::secondary, ImageIds::null, StringIds::tooltip_object_colour),
            makeWidget({ 609, 94 }, { 24, 24 }, WidgetType::wt_9, ColourIndex::secondary, ImageIds::plant_cluster_selected_tree, StringIds::plant_cluster_selected_tree),
            makeWidget({ 609, 118 }, { 24, 24 }, WidgetType::wt_9, ColourIndex::secondary, ImageIds::plant_cluster_random_tree, StringIds::plant_cluster_random_tree),
            widgetEnd(),
        };
    ...
    namespace ClearArea
    {
        ...
        Widget widgets[] = {
            ...
            makeWidget({ 33 + 16, 45 }, { 64, 44 }, WidgetType::wt_3, ColourIndex::secondary, ImageIds::tool_area, StringIds::tooltip_clear_area),
            makeWidget({ 34 + 16, 46 }, { 16, 16 }, WidgetType::wt_7, ColourIndex::secondary, Gfx::recolour(ImageIds::decrease_tool_area, Colour::white), StringIds::tooltip_decrease_clear_area),
            makeWidget({ 80 + 16, 72 }, { 16, 16 }, WidgetType::wt_7, ColourIndex::secondary, Gfx::recolour(ImageIds::increase_tool_area, Colour::white), StringIds::tooltip_increase_clear_area),
            widgetEnd(),
        };
    ...
    namespace AdjustLand
    {
        ...
        Widget widgets[] = {
            ...
            makeWidget({ 33 + 16, 45 }, { 64, 44 }, WidgetType::wt_3, ColourIndex::secondary, ImageIds::tool_area, StringIds::tooltip_adjust_land_tool),
            makeWidget({ 34 + 16, 46 }, { 16, 16 }, WidgetType::wt_7, ColourIndex::secondary, Gfx::recolour(ImageIds::decrease_tool_area, Colour::white), StringIds::tooltip_decrease_adjust_land_area),
            makeWidget({ 80 + 16, 72 }, { 16, 16 }, WidgetType::wt_7, ColourIndex::secondary, Gfx::recolour(ImageIds::increase_tool_area, Colour::white), StringIds::tooltip_increase_adjust_land_area),
            makeWidget({ 55 + 16, 92 }, { 20, 20 }, WidgetType::wt_6, ColourIndex::primary),
            widgetEnd(),
        };
    ...
    namespace AdjustWater
    {
        ...
        Widget widgets[] = {
            ...
            makeWidget({ 33 + 16, 45 }, { 64, 44 }, WidgetType::wt_3, ColourIndex::secondary, ImageIds::tool_area, StringIds::tooltip_adjust_water_tool),
            makeWidget({ 34 + 16, 46 }, { 16, 16 }, WidgetType::wt_7, ColourIndex::secondary, Gfx::recolour(ImageIds::decrease_tool_area, Colour::white), StringIds::tooltip_decrease_adjust_water_area),
            makeWidget({ 80 + 16, 72 }, { 16, 16 }, WidgetType::wt_7, ColourIndex::secondary, Gfx::recolour(ImageIds::increase_tool_area, Colour::white), StringIds::tooltip_increase_adjust_water_area),
            widgetEnd(),
        };
    ...
    namespace BuildWalls
    {
        ...
        Widget widgets[] = {
            ...
            makeWidget({ 2, 45 }, { 391, 48 }, WidgetType::scrollview, ColourIndex::secondary, Scrollbars::vertical),
            widgetEnd(),
        };
