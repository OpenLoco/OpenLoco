        ...
        static void drawScroll(Ui::Window& self, Gfx::Context& context, const uint32_t scrollIndex)
        {
            ...
            for (uint16_t i = 0; i < self.var_83C; i++)
            {
                ...
                // Industry Status
                {
                    ...
                    Gfx::drawString_494BBF(context, 200, yPos, 238, Colour2::black, text_colour_id, &args);
                }
                // Industry Production Delivered
                {
                    ...
                    Gfx::drawString_494BBF(context, 440, yPos, 138, Colour2::black, StringIds::production_transported_percent, &args);
                }
                yPos += rowHeight;
            }
        }
    ...
    namespace NewIndustries
    {
        ...
        static void draw(Window* self, Gfx::Context* context)
        {
            ...
            if (self->var_83C == 0)
            {
                ...
                Gfx::drawString_494BBF(*context, xPos, yPos, width, Colour2::black, StringIds::no_industry_available);
                return;
            }
            ...
            Gfx::drawString_494BBF(*context, xPos, yPos, width, Colour2::black, StringIds::black_stringid, &industryObj->name);
        }
