...
#define commonWidgets(frameWidth, frameHeight, windowCaptionId)                                                                                          \
    makeWidget({ 0, 0 }, { frameWidth, frameHeight }, WidgetType::frame, ColourIndex::primary),                                                          \
        makeWidget({ 1, 1 }, { frameWidth - 2, 13 }, WidgetType::caption_25, ColourIndex::primary, windowCaptionId),                                     \
        ...
        makeWidget({ 0, 41 }, { frameWidth, frameHeight - 41 }, WidgetType::panel, ColourIndex::secondary),                                              \
        makeRemapWidget({ 3, 15 }, { 31, 27 }, WidgetType::wt_8, ColourIndex::secondary, ImageIds::tab),                                                 \
        makeRemapWidget({ 34, 15 }, { 31, 27 }, WidgetType::wt_8, ColourIndex::secondary, ImageIds::tab),                                                \
        makeRemapWidget({ 65, 15 }, { 31, 27 }, WidgetType::wt_8, ColourIndex::secondary, ImageIds::tab),                                                \
        makeRemapWidget({ 96, 15 }, { 31, 27 }, WidgetType::wt_8, ColourIndex::secondary, ImageIds::tab)
    ...
    namespace Finances
    {
        ...
        static Widget _widgets[] = {
            ...
            makeWidget({ 4, 48 }, { windowSize.width - 8, 33 }, WidgetType::groupbox, ColourIndex::secondary, StringIds::cheat_increase_funds),
            makeStepperWidgets({ 80, 62 }, { 95, 12 }, WidgetType::wt_17, ColourIndex::secondary, StringIds::empty),
            makeWidget({ 180, 62 }, { 60, 12 }, WidgetType::wt_11, ColourIndex::secondary, StringIds::cheat_add),
            makeWidget({ 4, 86 }, { windowSize.width - 8, 33 }, WidgetType::groupbox, ColourIndex::secondary, StringIds::cheat_clear_loan),
            makeWidget({ 80, 100 }, { 95, 12 }, WidgetType::wt_17, ColourIndex::secondary),
            makeWidget({ 180, 100 }, { 60, 12 }, WidgetType::wt_11, ColourIndex::secondary, StringIds::cheat_clear),
            widgetEnd(),
        };
    ...
    namespace Companies
    {
        ...
        static Widget _widgets[] = {
            ...
            makeWidget({ 4, 48 }, { windowSize.width - 8, 33 }, WidgetType::groupbox, ColourIndex::secondary, StringIds::cheat_select_target_company),
            makeDropdownWidgets({ 10, 62 }, { windowSize.width - 20, 12 }, WidgetType::wt_17, ColourIndex::secondary),
            makeWidget({ 4, 86 }, { windowSize.width - 8, 80 }, WidgetType::groupbox, ColourIndex::secondary, StringIds::cheat_select_cheat_to_apply),
            makeWidget({ 10, 100 }, { windowSize.width - 20, 12 }, WidgetType::wt_11, ColourIndex::secondary, StringIds::cheat_switch_to_company),
            makeWidget({ 10, 116 }, { windowSize.width - 20, 12 }, WidgetType::wt_11, ColourIndex::secondary, StringIds::cheat_acquire_company_assets),
            makeWidget({ 10, 132 }, { windowSize.width - 20, 12 }, WidgetType::wt_11, ColourIndex::secondary, StringIds::cheat_toggle_bankruptcy),
            makeWidget({ 10, 148 }, { windowSize.width - 20, 12 }, WidgetType::wt_11, ColourIndex::secondary, StringIds::cheat_toggle_jail_status),
            widgetEnd(),
        };
    ...
    namespace Vehicles
    {
        ...
        static Widget _widgets[] = {
            ...
            makeWidget({ 4, 48 }, { windowSize.width - 8, 49 }, WidgetType::groupbox, ColourIndex::secondary, StringIds::cheat_set_vehicle_reliability),
            makeWidget({ 10, 62 }, { windowSize.width - 20, 12 }, WidgetType::wt_11, ColourIndex::secondary, StringIds::cheat_reliability_zero),
            makeWidget({ 10, 78 }, { windowSize.width - 20, 12 }, WidgetType::wt_11, ColourIndex::secondary, StringIds::cheat_reliability_hundred),
            widgetEnd(),
        };
    ...
    namespace Towns
    {
        ...
        static Widget _widgets[] = {
            ...
            makeWidget({ 4, 48 }, { windowSize.width - 8, 49 }, WidgetType::groupbox, ColourIndex::secondary, StringIds::cheat_set_ratings),
            makeWidget({ 10, 62 }, { (windowSize.width - 26) / 2, 12 }, WidgetType::wt_11, ColourIndex::secondary, StringIds::cheat_ratings_min_10pct),
            makeWidget({ 3 + (windowSize.width / 2), 62 }, { (windowSize.width - 26) / 2, 12 }, WidgetType::wt_11, ColourIndex::secondary, StringIds::cheat_ratings_plus_10pct),
            makeWidget({ 10, 78 }, { (windowSize.width - 26) / 2, 12 }, WidgetType::wt_11, ColourIndex::secondary, StringIds::cheat_ratings_to_min),
            makeWidget({ 3 + (windowSize.width / 2), 78 }, { (windowSize.width - 26) / 2, 12 }, WidgetType::wt_11, ColourIndex::secondary, StringIds::cheat_ratings_to_max),
            widgetEnd(),
        };
