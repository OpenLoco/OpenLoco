...
namespace OpenLoco::Ui::Windows::TimePanel
{
    ...
    static Widget _widgets[] = {
        makeWidget({ 0, 0 }, { 140, 29 }, WidgetType::wt_3, ColourIndex::primary),                                                                                        // 0,
        makeWidget({ 2, 2 }, { 136, 25 }, WidgetType::wt_3, ColourIndex::primary),                                                                                        // 1,
        makeWidget({ 113, 1 }, { 26, 26 }, WidgetType::wt_9, ColourIndex::primary),                                                                                       // 2,
        makeWidget({ 2, 2 }, { 111, 12 }, WidgetType::wt_9, ColourIndex::primary, ImageIds::null, StringIds::tooltip_daymonthyear_challenge),                             // 3,
        makeRemapWidget({ 18, 15 }, { 20, 12 }, WidgetType::wt_9, ColourIndex::primary, ImageIds::speed_pause, StringIds::tooltip_speed_pause),                           // 4,
        makeRemapWidget({ 38, 15 }, { 20, 12 }, WidgetType::wt_9, ColourIndex::primary, ImageIds::speed_normal, StringIds::tooltip_speed_normal),                         // 5,
        makeRemapWidget({ 58, 15 }, { 20, 12 }, WidgetType::wt_9, ColourIndex::primary, ImageIds::speed_fast_forward, StringIds::tooltip_speed_fast_forward),             // 6,
        makeRemapWidget({ 78, 15 }, { 20, 12 }, WidgetType::wt_9, ColourIndex::primary, ImageIds::speed_extra_fast_forward, StringIds::tooltip_speed_extra_fast_forward), // 7,
        widgetEnd(),
    };
