    ...
    namespace Land
    {
        ...
        static void drawScroll(Ui::Window& window, Gfx::Context& context, const uint32_t scrollIndex)
        {
            ...
            for (uint16_t i = 0; i < maxLandObjects; i++)
            {
                ...
                Gfx::drawString_494BBF(context, 24, yPos + 5, 121, Colour2::black, StringIds::wcolour2_stringid, &*commonFormatArgs);
                ...
                Gfx::drawString_494BBF(context, 151, yPos + 5, 177, Colour2::black, StringIds::black_stringid, &*commonFormatArgs);
                ...
                // Draw triangle (knob).
                Gfx::drawString_494B3F(context, 330, yPos + 6, Colour2::black, StringIds::dropdown, nullptr);
