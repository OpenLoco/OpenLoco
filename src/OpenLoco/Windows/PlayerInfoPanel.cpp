...
namespace OpenLoco::Ui::Windows::PlayerInfoPanel
{
    ...
    static Widget _widgets[] = {
        ...
        makeWidget({ 1, 1 }, { 26, 26 }, WidgetType::tooltip, WindowColour::primary),
        makeWidget({ 27, 2 }, { 111, 12 }, WidgetType::tooltip, WindowColour::primary, ImageIds::null, StringIds::tooltip_company_value),
        makeWidget({ 27, 14 }, { 111, 12 }, WidgetType::tooltip, WindowColour::primary, ImageIds::null, StringIds::tooltip_performance_index),
        widgetEnd(),
    };
