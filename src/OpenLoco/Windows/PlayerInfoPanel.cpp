...
namespace OpenLoco::Ui::Windows::PlayerInfoPanel
{
    ...
    static Widget _widgets[] = {
        ...
        makeWidget({ 27, 2 }, { 111, 12 }, WidgetType::buttonWithImage, WindowColour::primary, Widget::contentNull, StringIds::tooltip_company_value),
        makeWidget({ 27, 14 }, { 111, 12 }, WidgetType::buttonWithImage, WindowColour::primary, Widget::contentNull, StringIds::tooltip_performance_index),
        widgetEnd(),
    };
