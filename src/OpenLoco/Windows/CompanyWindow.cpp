...
#define commonWidgets(frameWidth, frameHeight, windowCaptionId)                                                                             \
    ...
    namespace status
    {
        ...
        static void renameCompanyOwnerName(window* self, char* input)
        {
            ...
            char* buffer = const_cast<char*>(StringManager::getString(string_ids::buffer_2039));
            strcpy(buffer, input);
            ...
            StringManager::formatString(input, string_ids::company_owner_name_transport, const_cast<void*>(&args));
