...
#define commonWidgets(frameWidth, frameHeight, windowCaptionId)                                                                                                      \
    ...
    namespace Status
    {
        ...
        static Widget widgets[] = {
            ...
            makeWidget({ 0, 0 }, { 24, 24 }, WidgetType::buttonWithImage, WindowColour::secondary, Widget::contentNull, StringIds::move_main_view_to_show_this),
            makeWidget({ 178, 57 }, { 66, 66 }, WidgetType::buttonWithImage, WindowColour::secondary, Widget::contentNull),
            makeWidget({ 154, 124 }, { 112, 22 }, WidgetType::buttonWithImage, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_change_owner_name),
            widgetEnd(),
        };
    ...
    namespace Details
    {
        ...
        static Widget widgets[] = {
            ...
            makeWidget({ 315, 92 }, { 24, 24 }, WidgetType::buttonWithImage, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_build_or_move_headquarters),
            makeWidget({ 0, 0 }, { 24, 24 }, WidgetType::buttonWithImage, WindowColour::secondary, Widget::contentNull, StringIds::move_main_view_to_show_this),
            widgetEnd(),
        };
    ...
    namespace ColourScheme
    {
        ...
        static Widget widgets[] = {
            ...
            makeWidget({ 221, 48 }, { 16, 16 }, WidgetType::buttonWithColour, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_select_main_colour),
            makeWidget({ 221, 78 }, { 16, 16 }, WidgetType::buttonWithColour, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_select_main_colour),
            makeWidget({ 221, 95 }, { 16, 16 }, WidgetType::buttonWithColour, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_select_main_colour),
            makeWidget({ 221, 112 }, { 16, 16 }, WidgetType::buttonWithColour, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_select_main_colour),
            makeWidget({ 221, 129 }, { 16, 16 }, WidgetType::buttonWithColour, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_select_main_colour),
            makeWidget({ 221, 146 }, { 16, 16 }, WidgetType::buttonWithColour, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_select_main_colour),
            makeWidget({ 221, 163 }, { 16, 16 }, WidgetType::buttonWithColour, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_select_main_colour),
            makeWidget({ 221, 180 }, { 16, 16 }, WidgetType::buttonWithColour, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_select_main_colour),
            makeWidget({ 221, 197 }, { 16, 16 }, WidgetType::buttonWithColour, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_select_main_colour),
            makeWidget({ 221, 214 }, { 16, 16 }, WidgetType::buttonWithColour, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_select_main_colour),
            makeWidget({ 221, 231 }, { 16, 16 }, WidgetType::buttonWithColour, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_select_main_colour),
            makeWidget({ 239, 48 }, { 16, 16 }, WidgetType::buttonWithColour, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_select_secondary_colour),
            makeWidget({ 239, 78 }, { 16, 16 }, WidgetType::buttonWithColour, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_select_secondary_colour),
            makeWidget({ 239, 95 }, { 16, 16 }, WidgetType::buttonWithColour, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_select_secondary_colour),
            makeWidget({ 239, 112 }, { 16, 16 }, WidgetType::buttonWithColour, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_select_secondary_colour),
            makeWidget({ 239, 129 }, { 16, 16 }, WidgetType::buttonWithColour, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_select_secondary_colour),
            makeWidget({ 239, 146 }, { 16, 16 }, WidgetType::buttonWithColour, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_select_secondary_colour),
            makeWidget({ 239, 163 }, { 16, 16 }, WidgetType::buttonWithColour, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_select_secondary_colour),
            makeWidget({ 239, 180 }, { 16, 16 }, WidgetType::buttonWithColour, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_select_secondary_colour),
            makeWidget({ 239, 197 }, { 16, 16 }, WidgetType::buttonWithColour, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_select_secondary_colour),
            makeWidget({ 239, 214 }, { 16, 16 }, WidgetType::buttonWithColour, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_select_secondary_colour),
            makeWidget({ 239, 231 }, { 16, 16 }, WidgetType::buttonWithColour, WindowColour::secondary, Widget::contentNull, StringIds::tooltip_select_secondary_colour),
            widgetEnd(),
        };
