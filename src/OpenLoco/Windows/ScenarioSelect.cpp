...
namespace OpenLoco::Ui::Windows::ScenarioSelect
{
    ...
    static void draw(Window* self, Gfx::Context* context)
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            Gfx::drawStringCentredWrapped(*context, origin, widget.width() - 4, Colour2::black, StringIds::wcolour2_stringid, &caption);
        }
        ...
        // Scenario name
        {
            ...
            x += colWidth / 2;
            Gfx::drawStringCentredClipped(*context, x, y, 170, Colour2::black, StringIds::wcolour2_stringid, &args);
        ...
        else
        {
            ...
            Gfx::drawStringCentredWrapped(*context, origin, 128, Colour2::black, StringIds::wcolour2_stringid, &args);
        }

        {
            ...
            auto args = FormatArguments();
            args.push(StringIds::buffer_2039);
            y = Gfx::drawString_495224(*context, x, y, 170, Colour2::black, StringIds::black_stringid, &args);

            // Challenge header
            y += 5;
            auto origin = Ui::Point(x, y);
            Gfx::drawString_494B3F(*context, &origin, Colour2::black, StringIds::challenge_label, nullptr);
            ...
            y = Gfx::drawString_495224(*context, x, y, 170, Colour2::black, StringIds::challenge_value, &args);

            // Start year
            y += 5;
            args = FormatArguments();
            args.push(scenarioInfo->startYear);
            Gfx::drawString_494B3F(*context, x, y, Colour2::black, StringIds::challenge_start_date, &args);
            ...
            y = Gfx::drawString_495224(*context, x, y, 170, Colour2::black, competitionStringId, &args);
            ...
            Gfx::drawString_494B3F(*context, x, y, Colour2::black, competitionStringId, &args);
        }
    }
    ...
    static void drawScroll(Window& self, Gfx::Context& context, const uint32_t)
    {
        ...
        for (auto i = 0; i < scenarioCount; i++)
        {
            ...
            // Scenario name
            {
                ...
                const int16_t x = 210;
                Gfx::drawStringCentred(context, x, y + 1, Colour2::black, formatStringId, &args);
            }
            ...
            // 'Completed by' info
            {
                ...
                Gfx::drawStringCentred(context, x, y + 10, Colour2::black, formatStringId, &args);
            }
