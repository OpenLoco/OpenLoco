...
namespace OpenLoco::Ui::Windows::ToolbarBottom::Editor
{
    ...
    static Widget _widgets[] = {
        ...
        makeWidget({ 2, 2 }, { 196, 30 }, WidgetType::tooltip, WindowColour::primary),
        makeWidget({ 440, 0 }, { 200, 34 }, WidgetType::wt_3, WindowColour::primary),
        makeWidget({ 442, 2 }, { 196, 30 }, WidgetType::tooltip, WindowColour::primary),
        widgetEnd(),
    };
    ...
    {
        self->widgets[widx::next_button].type = WidgetType::tooltip;
        self->widgets[widx::next_frame].type = WidgetType::wt_3;

        if (EditorController::canGoBack())
        {
            self->widgets[widx::previous_button].type = WidgetType::tooltip;
