...
namespace OpenLoco::Ui::Windows::ToolbarBottom::Editor
{
    ...
    static Widget _widgets[] = {
        ...
        makeWidget({ 2, 2 }, { 196, 30 }, WidgetType::button_with_image, WindowColour::primary),
        makeWidget({ 440, 0 }, { 200, 34 }, WidgetType::wt_3, WindowColour::primary),
        makeWidget({ 442, 2 }, { 196, 30 }, WidgetType::button_with_image, WindowColour::primary),
        widgetEnd(),
    };
    ...
    {
        self->widgets[widx::next_button].type = WidgetType::button_with_image;
        self->widgets[widx::next_frame].type = WidgetType::wt_3;

        if (EditorController::canGoBack())
        {
            self->widgets[widx::previous_button].type = WidgetType::button_with_image;
