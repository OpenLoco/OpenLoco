...
#pragma pack(push, 1)
    ...
    struct GeneralState
    {
        ...
        uint8_t lastTrackBuilt;                             // 0x000192 (0x00525FAA)
        uint8_t lastRoadBuilt;                              // 0x000193 (0x00525FAB)
        uint8_t lastAirportBuilt;                           // 0x000194 (0x00525FAC)
        uint8_t lastShipPortBuilt;                          // 0x000195 (0x00525FAD)
