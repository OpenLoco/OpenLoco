...
namespace OpenLoco
{
    ...
    struct Reflection<S5::GeneralState>
    {
        using Fields = FieldList<
            ...
            REFL_FIELD(S5::GeneralState, lastRailroadOption),
            REFL_FIELD(S5::GeneralState, lastRoadOption),
            ...
            REFL_FIELD(S5::GeneralState, lastTrackTypeOption),
            REFL_FIELD(S5::GeneralState, loanInterestRate),
            REFL_FIELD(S5::GeneralState, lastIndustryOption),
            REFL_FIELD(S5::GeneralState, lastBuildingOption),
            REFL_FIELD(S5::GeneralState, lastMiscBuildingOption),
            REFL_FIELD(S5::GeneralState, lastWallOption),
            ...
            REFL_FIELD(S5::GeneralState, lastBuildVehiclesOption),
