...
#pragma pack(pop)
    ...
    namespace Literals
    {
        constexpr uint32_t operator"" _mph32(long double speedMph)
        {
        ...
        static_assert(2.75_mph32 == 0x2C000);
        static_assert(4.0_mph32 == 0x40000);
        static_assert(14.0_mph32 == 0xE0000);
    }
}
