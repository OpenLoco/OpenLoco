...
namespace OpenLoco::Ui
{
    struct Widget
    {
        ...
        static void drawPanel(Gfx::Context* context, Window* window, Widget* widget, uint16_t flags, uint8_t colour);
        static void drawFrame(Gfx::Context* context, Window* window, Widget* widget, uint16_t flags, uint8_t colour);
        static void draw_3(Gfx::Context* context, Window* window, Widget* widget, uint16_t flags, uint8_t colour, bool enabled, bool disabled, bool activated);

        static void draw_5(Gfx::Context* context, Window* window, Widget* widget, uint16_t flags, uint8_t colour, bool enabled, bool disabled, bool activated);

        static void draw_9(Gfx::Context* context, Window* window, Widget* widget, uint16_t flags, uint8_t colour, bool enabled, bool disabled, bool activated, bool hovered);
        static void draw_10(Gfx::Context* context, Window* window, Widget* widget, uint16_t flags, uint8_t colour, bool enabled, bool disabled, bool activated, bool hovered);

        static void draw_11_a(Gfx::Context* context, Window* window, Widget* widget, uint16_t flags, uint8_t colour, bool enabled, bool disabled, bool activated);
        static void draw_13(Gfx::Context* context, Window* window, Widget* widget, uint16_t flags, uint8_t colour, bool enabled, bool disabled, bool activated);

        static void draw_15(Gfx::Context* context, Window* window, Widget* widget, uint16_t flags, uint8_t colour, bool disabled);

        static void draw_17(Gfx::Context* context, Window* window, Widget* widget, uint16_t flags, uint8_t colour);

        static void draw_22_caption(Gfx::Context* context, Window* window, Widget* widget, uint16_t flags, uint8_t colour);
        static void draw_23_caption(Gfx::Context* context, Window* window, Widget* widget, uint16_t flags, uint8_t colour);
        static void draw_24_caption(Gfx::Context* context, Window* window, Widget* widget, uint16_t flags, uint8_t colour);
        static void draw_25_caption(Gfx::Context* context, Window* window, Widget* widget, uint16_t flags, uint8_t colour);
        ...
        static void draw_27_checkbox(Gfx::Context* context, Window* window, Widget* widget, uint16_t flags, uint8_t colour, bool enabled, bool disabled, bool activated);
        static void draw_27_label(Gfx::Context* context, Window* window, Widget* widget, uint16_t flags, uint8_t colour, bool disabled);

        static void draw_29(Gfx::Context* context, Window* window, Widget* widget);

        static void drawGroupbox(Gfx::Context* const context, Window* const window, Widget* widget);
