...
#pragma pack(push, 1)
    struct Widget
    {
        ...
        static constexpr uint32_t contentNull = 0xFFFFFFFF;
...
#pragma pack(pop)
    ...
    static constexpr Widget makeWidget(Ui::Point origin, Ui::Size size, WidgetType type, WindowColour colour, uint32_t content = Widget::contentNull, string_id tooltip = StringIds::null)
    {
        Widget out = {};
        out.left = origin.x;
    ...
    constexpr Widget makeRemapWidget(Ui::Point origin, Ui::Size size, WidgetType type, WindowColour colour, uint32_t content = Widget::contentNull, string_id tooltip = StringIds::null)
    {
...
#define makeDropdownWidgets(...) \
    ...
    [[maybe_unused]] static constexpr Widget makeDropdownButtonWidget(Ui::Point origin, Ui::Size size, [[maybe_unused]] WidgetType type, WindowColour colour, [[maybe_unused]] uint32_t content = Widget::contentNull, [[maybe_unused]] string_id tooltip = StringIds::null)
    {
...
#define makeStepperWidgets(...)                 \
    ...
    [[maybe_unused]] static constexpr Widget makeStepperDecreaseWidget(Ui::Point origin, Ui::Size size, [[maybe_unused]] WidgetType type, WindowColour colour, [[maybe_unused]] uint32_t content = Widget::contentNull, [[maybe_unused]] string_id tooltip = StringIds::null)
    {
    ...
    [[maybe_unused]] static constexpr Widget makeStepperIncreaseWidget(Ui::Point origin, Ui::Size size, [[maybe_unused]] WidgetType type, WindowColour colour, [[maybe_unused]] uint32_t content = Widget::contentNull, [[maybe_unused]] string_id tooltip = StringIds::null)
    {
