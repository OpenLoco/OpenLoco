...
namespace OpenLoco::Drawing
{
    ...
    public:
        ...
        void fillRectInset(Gfx::RenderTarget& rt, int16_t left, int16_t top, int16_t right, int16_t bottom, AdvancedColour colour, DrawRectInsetFlags flags) override;
        void drawRectInset(Gfx::RenderTarget& rt, int16_t x, int16_t y, uint16_t dx, uint16_t dy, AdvancedColour colour, DrawRectInsetFlags flags) override;
