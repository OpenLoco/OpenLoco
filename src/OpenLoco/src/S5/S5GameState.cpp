...
namespace OpenLoco::S5
{
    ...
    static S5::GeneralState exportGeneralState(const OpenLoco::GameState& src)
    {
        ...
        dst.defaultMiscBuildingObjectId = src.defaultMiscBuildingObjectId;
        dst.defaultWallObjectId = src.defaultWallObjectId;
