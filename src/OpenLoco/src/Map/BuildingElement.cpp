    ...
    bool BuildingElement::update(const Map::Pos2& loc)
    {
        ...
        if (!isConstructed())
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if ((buildingObj->flags & BuildingObjectFlags::largeTile) != BuildingObjectFlags::none)
                    {
                        for (auto i = 1; i < 4; ++i)
                        {
        ...
        if (isConstructed())
        {
            ...
            for (auto i = 0; i < 2; ++i)
            {
                ...
                const auto size = ((buildingObj->flags & BuildingObjectFlags::largeTile) != BuildingObjectFlags::none) ? Map::TilePos2(2, 2) : Map::TilePos2(1, 1);
