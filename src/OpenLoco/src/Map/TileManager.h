...
namespace OpenLoco::World::TileManager
{
    ...
    bool sub_462908(const World::Pos2& pos, uint8_t baseZ, uint8_t clearZ, const QuarterTile& qt, uint32_t clearFunctionLegacy = 0);
    bool sub_462917(const World::Pos2& pos, uint8_t baseZ, uint8_t clearZ, const QuarterTile& qt, uint32_t clearFunctionLegacy = 0);
