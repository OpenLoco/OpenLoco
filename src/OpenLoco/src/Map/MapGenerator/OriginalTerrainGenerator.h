...
namespace OpenLoco::World::MapGenerator
{
    ...
    private:
        // 0x004626B7
        void blitHill(const Options& options, HeightMap& heightMap);
        ...
        // 0x00462518
        void generateHills(const Options& options, HeightMap& heightMap);
    ...
    public:
        // 0x004624F0
        void generate(const Options& options, HeightMap& heightMap);
    };
}
