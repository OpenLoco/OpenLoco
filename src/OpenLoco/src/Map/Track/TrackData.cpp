...
namespace OpenLoco::World::TrackData
{
    ...
    uint16_t getTrackCompatibleFlags(size_t trackId)
    {
        for (auto i = 0; i < 44; ++i)
        {
            ...
            fmt::println(".costFactor = 0x{:03X},\n.flags = {:#011b},\n.reverseTrackId = {},", data.costFactor, data.flags, data.reverseTrackId);
