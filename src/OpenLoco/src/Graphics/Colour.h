...
namespace OpenLoco
{
    ...
    namespace PaletteIndex
    {
        ...
        constexpr PaletteIndex_t index_2F = 0x2F;
        ...
        constexpr PaletteIndex_t index_3C = 0x3C;
        constexpr PaletteIndex_t index_3D = 0x3D;
        ...
        constexpr PaletteIndex_t index_D8 = 0xD8;
