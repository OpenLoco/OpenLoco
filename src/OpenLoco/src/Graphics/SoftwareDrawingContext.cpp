...
namespace OpenLoco::Gfx
{
    ...
    {
        TextRenderer tr(*this);
        return tr.getStringWidth(buffer);
    }
    ...
    {
        TextRenderer tr(*this);
        return tr.drawString(rt, origin, colour, str);
    }
    ...
    {
        TextRenderer tr(*this);
        return tr.drawStringLeftClipped(rt, origin, width, colour, stringId, args);
    }
    ...
    {
        TextRenderer tr(*this);
        return tr.drawStringLeftUnderline(rt, origin, colour, stringId, args);
    }
    ...
    {
        TextRenderer tr(*this);
        return tr.drawStringLeftWrapped(rt, origin, width, colour, stringId, args);
    }
    ...
    {
        TextRenderer tr(*this);
        return tr.drawStringCentred(rt, origin, colour, stringId, args);
    }
    ...
    {
        TextRenderer tr(*this);
        return tr.drawStringCentredClipped(rt, origin, width, colour, stringId, args);
    }
    ...
    {
        TextRenderer tr(*this);
        return tr.drawStringCentredWrapped(rt, origin, width, colour, stringId, args);
    }
    ...
    {
        TextRenderer tr(*this);
        return tr.drawStringRight(rt, origin, colour, stringId, args);
    }
    ...
    {
        TextRenderer tr(*this);
        return tr.drawStringTicker(rt, origin, stringId, colour, numLinesToDisplay, numCharactersToDisplay, width);
    }
