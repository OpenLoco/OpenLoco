...
namespace OpenLoco::Ui::Windows::ScenarioSelect
{
    ...
    static void draw(Window& self, Gfx::RenderTarget* rt)
    {
        ...
        drawingCtx.drawRectInset(*rt, self.x, self.y + 20, self.width, 41, self.getColour(WindowColour::primary), 0);
        ...
        {
            x = baseX + 20;
            drawingCtx.drawRectInset(*rt, x, y, 130, 130, self.getColour(WindowColour::secondary), 0x30);
    ...
    static void drawScroll(Window& self, Gfx::RenderTarget& rt, const uint32_t)
    {
        ...
        for (auto i = 0; i < scenarioCount; i++)
        {
            ...
            {
                drawingCtx.drawRect(rt, 0, y, self.width, kRowHeight - 1, 0x2000000 | 48);
