...
namespace OpenLoco::Ui::Windows::Construction::Signal
{
    ...
    {
        Common::onUpdate(&self, GhostFlags::signalGhostVisible);
    }
    ...
    static uint32_t placeSignalGhost(const GameCommands::SignalPlacementArgs& args)
    {
        ...
        {
            _byte_522096 = _byte_522096 | GhostFlags::signalGhostVisible;
    ...
    {
        if ((_byte_522096 & GhostFlags::signalGhostVisible) != GhostFlags::none)
        {
