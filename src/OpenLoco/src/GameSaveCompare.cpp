...
namespace OpenLoco::GameSaveCompare
{
    ...
    bool compareGameStates(S5::GameState& gameState1, S5::GameState& gameState2, bool displayAllDivergences)
    {
        ...
        foundDivergence |= isLoggedDivergence("pad_B886", gameState1.general.pad_B886, gameState2.general.pad_B886, 0xB94C - 0xB886, displayAllDivergences);
        foundDivergence |= isLoggedDivergentGameStateField("var_B94C", 0, gameState1.general.var_B94C, gameState2.general.var_B94C);
        foundDivergence |= isLoggedDivergence("pad_B94D", gameState1.general.pad_B94D, gameState2.general.pad_B94D, 0xB950 - 0xB94D, displayAllDivergences);
        foundDivergence |= isLoggedDivergentGameStateField("var_B950", 0, gameState1.general.var_B950, gameState2.general.var_B950);
        foundDivergence |= isLoggedDivergentGameStateField("pad_B951", 0, gameState1.general.pad_B951, gameState2.general.pad_B951);
        foundDivergence |= isLoggedDivergentGameStateField("var_B952", 0, gameState1.general.var_B952, gameState2.general.var_B952);
        foundDivergence |= isLoggedDivergentGameStateField("pad_B953", 0, gameState1.general.pad_B953, gameState2.general.pad_B953);
        foundDivergence |= isLoggedDivergentGameStateField("var_B954", 0, gameState1.general.var_B954, gameState2.general.var_B954);
        foundDivergence |= isLoggedDivergentGameStateField("pad_B955", 0, gameState1.general.pad_B955, gameState2.general.pad_B955);
        foundDivergence |= isLoggedDivergentGameStateField("var_B956", 0, gameState1.general.var_B956, gameState2.general.var_B956);
        foundDivergence |= isLoggedDivergence("pad_B957", gameState1.general.pad_B957, gameState2.general.pad_B957, 0xB968 - 0xB957, displayAllDivergences);
