...
namespace OpenLoco::Audio
{
    ...
    {
        if ((v->var_4A & Vehicles::SoundFlags::flag0) != Vehicles::SoundFlags::none)
        {
    ...
    static void sub_48A274(Vehicles::Vehicle2or6* v)
    {
        ...
        if (main != nullptr && main->viewports[0] != nullptr)
        {
            ...
            if (extendedViewport.contains(spritePosition))
            {
                ...
                v->var_4A |= Vehicles::SoundFlags::flag0;
    ...
    static void off_4FEB58(Vehicles::Vehicle2or6* v, int32_t x)
    {
        switch (x)
        {
            case 0:
                ...
                break;
            case 1:
                if ((v->var_4A & Vehicles::SoundFlags::flag1) == Vehicles::SoundFlags::none)
                {
                    sub_48A274(v);
                }
                break;
