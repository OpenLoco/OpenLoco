...
namespace OpenLoco::Ui::Windows::Construction::Construction
{
    ...
    {
        removeTrackGhosts();
        const auto res = GameCommands::doCommand(args, GameCommands::Flags::apply | GameCommands::Flags::skipGhostPlacement | GameCommands::Flags::noErrorWindow | GameCommands::Flags::noPayment | GameCommands::Flags::ghost);
