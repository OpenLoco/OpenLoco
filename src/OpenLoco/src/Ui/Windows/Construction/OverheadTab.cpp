...
namespace OpenLoco::Ui::Windows::Construction::Overhead
{
    ...
    {
        auto res = GameCommands::doCommand(args, GameCommands::Flags::apply | GameCommands::Flags::skipGhostPlacement | GameCommands::Flags::noErrorWindow | GameCommands::Flags::noPayment | GameCommands::Flags::ghost);
