    ...
    namespace Common
    {
        ...
        static constexpr auto makeCommonWidgets(int32_t frameWidth, int32_t frameHeight, StringId windowCaptionId)
        {
            return makeWidgets(
                ...
                makeWidget({ 3, 15 }, { 31, 27 }, WidgetType::wt_6, WindowColour::secondary, ImageIds::tab, StringIds::tooltip_adjust_land),
                makeWidget({ 3, 15 }, { 31, 27 }, WidgetType::wt_6, WindowColour::secondary, ImageIds::tab, StringIds::tooltip_adjust_water),
                makeWidget({ 3, 15 }, { 31, 27 }, WidgetType::wt_6, WindowColour::secondary, ImageIds::tab, StringIds::tooltip_plant_trees),
                makeWidget({ 3, 15 }, { 31, 27 }, WidgetType::wt_6, WindowColour::secondary, ImageIds::tab, StringIds::tooltip_build_walls));
        }
        ...
        static int16_t decrementToolSize();
        static int16_t incrementToolSize();
    ...
    namespace ClearArea
    {
        ...
        static void onMouseDown(Window& self, WidgetIndex_t widgetIndex)
        {
            switch (widgetIndex)
            {
                ...
                {
                    _clearAreaToolSize = Common::decrementToolSize();
                    self.invalidate();
                    break;
                }
                ...
                {
                    _clearAreaToolSize = Common::incrementToolSize();
                    self.invalidate();
                    break;
                }
            }
    ...
    namespace AdjustLand
    {
        ...
        static void onMouseDown(Window& self, WidgetIndex_t widgetIndex)
        {
            switch (widgetIndex)
            {
                ...
                case widx::decrease_area:
                {
                    _adjustLandToolSize = Common::decrementToolSize();
                    self.invalidate();
                    break;
                }
                ...
                case widx::increase_area:
                {
                    _adjustLandToolSize = Common::incrementToolSize();
                    self.invalidate();
                    break;
                }
            }
    ...
    namespace AdjustWater
    {
        ...
        static void onMouseDown(Window& self, WidgetIndex_t widgetIndex)
        {
            switch (widgetIndex)
            {
                case widx::decrease_area:
                {
                    _adjustWaterToolSize = Common::decrementToolSize();
                    self.invalidate();
                    break;
                }
                ...
                case widx::increase_area:
                {
                    _adjustWaterToolSize = Common::incrementToolSize();
                    self.invalidate();
                    break;
                }
            }
