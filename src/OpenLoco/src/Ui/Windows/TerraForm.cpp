...
namespace OpenLoco::Ui::Windows::Terraform
{
    ...
    namespace PlantTrees
    {
        ...
        static void tabReset(Window& self)
        {
            ...
            _lastTreeCost = GameCommands::FAILURE;
            self.rowCount = 0;
            self.rowHover = -1;
        ...
        static void draw(Window& self, Gfx::DrawingContext& drawingCtx)
        {
            ...
            uint32_t treeCost = GameCommands::FAILURE;
            if (self.var_846 == 0xFFFF)
            {
                treeCost = _lastTreeCost;
                if (treeCost == GameCommands::FAILURE)
                {
    ...
    namespace ClearArea
    {
        ...
        static void tabReset(Window& self)
        {
            ...
            Input::setFlag(Input::Flags::flag6);
            _raiseLandCost = GameCommands::FAILURE;
        ...
        static void onToolUpdate([[maybe_unused]] Window& self, [[maybe_unused]] const WidgetIndex_t widgetIndex, [[maybe_unused]] const WidgetId id, const int16_t x, const int16_t y)
        {
            ...
            uint32_t cost = GameCommands::FAILURE;
        ...
        static void draw(Window& self, Gfx::DrawingContext& drawingCtx)
        {
            ...
            if (_raiseLandCost == GameCommands::FAILURE)
            {
                return;
            }
    ...
    namespace AdjustLand
    {
        ...
        static void tabReset(Window& self)
        {
            ...
            for (auto i = 0; i < 32; i++)
            {
                ...
                _lastSelectedLand = i;
                _raiseLandCost = GameCommands::FAILURE;
                _lowerLandCost = GameCommands::FAILURE;
        ...
        static void onAdjustLandToolUpdate([[maybe_unused]] const OpenLoco::Ui::WidgetIndex_t& widgetIndex, const int16_t& x, const int16_t& y)
        {
            ...
            {
                raiseCost = GameCommands::FAILURE;
                lowerCost = GameCommands::FAILURE;
            }
            else
            {
        ...
        static void draw(Window& self, Gfx::DrawingContext& drawingCtx)
        {
            ...
            if (_lowerLandCost != GameCommands::FAILURE)
            {
                if (_lowerLandCost != 0)
                {
                    FormatArguments args{};
    ...
    namespace AdjustWater
    {
        ...
        static void tabReset(Window& self)
        {
            ...
            Input::setFlag(Input::Flags::flag6);
            _raiseWaterCost = GameCommands::FAILURE;
            _lowerWaterCost = GameCommands::FAILURE;
        ...
        static void onToolUpdate([[maybe_unused]] Window& self, const WidgetIndex_t widgetIndex, [[maybe_unused]] const WidgetId id, const int16_t x, const int16_t y)
        {
            ...
            if (ToolManager::getToolCursor() != CursorId::upDownArrow)
            {
                ...
                {
                    setAdjustCost(GameCommands::FAILURE, GameCommands::FAILURE);
                    return;
                }
        ...
        static void draw(Window& self, Gfx::DrawingContext& drawingCtx)
        {
            ...
            if (_raiseWaterCost != GameCommands::FAILURE)
            {
            ...
            if (_lowerWaterCost != GameCommands::FAILURE)
            {
