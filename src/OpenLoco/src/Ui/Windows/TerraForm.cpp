...
namespace OpenLoco::Ui::Windows::Terraform
{
    ...
    namespace PlantTrees
    {
        ...
        static constexpr auto widgets = makeWidgets(
            ...
            Widgets::ScrollView(Widx::kScrollview, { 3, 45 }, { 605, 101 }, WindowColour::secondary, Scrollbars::vertical),
    ...
    namespace BuildWalls
    {
        ...
        static constexpr auto widgets = makeWidgets(
            ...
            Widgets::ScrollView(Widx::kScrollview, { 2, 45 }, { 391, 48 }, WindowColour::secondary, Scrollbars::vertical)
