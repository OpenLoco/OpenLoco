...
#include "Ui/Widgets/CornerButtonWidget.h"
...
namespace OpenLoco::Ui::Windows::Terraform
{
    ...
    namespace ClearArea
    {
        ...
        static constexpr auto widgets = makeWidgets(
            ...
            Widgets::CornerButton(Widx::kDecreaseArea, { 34 + 16, 46 }, { 16, 16 }, WindowColour::secondary, Gfx::recolour(ImageIds::decrease_tool_area, Colour::white), StringIds::tooltip_decrease_clear_area),
            Widgets::CornerButton(Widx::kIncreaseArea, { 80 + 16, 72 }, { 16, 16 }, WindowColour::secondary, Gfx::recolour(ImageIds::increase_tool_area, Colour::white), StringIds::tooltip_increase_clear_area)
    ...
    namespace AdjustLand
    {
        ...
        static constexpr auto widgets = makeWidgets(
            ...
            Widgets::CornerButton(Widx::kDecreaseArea, { 50, 46 }, { 16, 16 }, WindowColour::secondary, Gfx::recolour(ImageIds::decrease_tool_area, Colour::white), StringIds::tooltip_decrease_adjust_land_area),
            Widgets::CornerButton(Widx::kIncreaseArea, { 96, 72 }, { 16, 16 }, WindowColour::secondary, Gfx::recolour(ImageIds::increase_tool_area, Colour::white), StringIds::tooltip_increase_adjust_land_area),
    ...
    namespace AdjustWater
    {
        ...
        static constexpr auto widgets = makeWidgets(
            ...
            Widgets::CornerButton(Widx::kDecreaseArea, { 34 + 16, 46 }, { 16, 16 }, WindowColour::secondary, Gfx::recolour(ImageIds::decrease_tool_area, Colour::white), StringIds::tooltip_decrease_adjust_water_area),
            Widgets::CornerButton(Widx::kIncreaseArea, { 80 + 16, 72 }, { 16, 16 }, WindowColour::secondary, Gfx::recolour(ImageIds::increase_tool_area, Colour::white), StringIds::tooltip_increase_adjust_water_area)
