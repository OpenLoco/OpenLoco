...
namespace OpenLoco::Ui::Windows::Vehicle
{
    ...
    namespace Details
    {
        ...
        static void onMouseUp(Window& self, WidgetIndex_t widgetIndex)
        {
            switch (widgetIndex)
            {
                ...
                case widx::paintBrush:
                    ...
                    colourPrimary = Gfx::getPrimaryColour(self.widgets[widx::paintColourPrimary].image);
                    colourSecondary = Gfx::getPrimaryColour(self.widgets[widx::paintColourSecondary].image);
                    self.invalidate();
                    break;
            }
        }
        ...
        static void prepareDraw(Window& self)
        {
            ...
            self.widgets[widx::paintBrush].type = WidgetType::buttonWithImage;
            ...
            if (head->owner != CompanyManager::getControllingId())
            {
                ...
                self.widgets[Details::widx::paintColourPrimary].type = WidgetType::none;
                self.widgets[Details::widx::paintColourSecondary].type = WidgetType::none;
                ...
                self.widgets[widx::paintBrush].type = WidgetType::none;
    ...
    namespace Common
    {
        ...
        static void switchTab(Window* self, WidgetIndex_t widgetIndex)
        {
            ...
            if (widgetIndex == Common::tabDetails)
            {
                ...
                auto colour = CompanyManager::getCompanyColour(self->owner);
