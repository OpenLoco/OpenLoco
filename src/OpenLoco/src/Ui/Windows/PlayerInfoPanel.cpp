...
namespace OpenLoco::Ui::Windows::PlayerInfoPanel
{
    ...
    static void playerMouseDown(Ui::Window* self, WidgetIndex_t widgetIndex)
    {
        ...
        for (auto company : _sortedCompanies)
        {
            ...
            args.push(Gfx::recolour(competitorObj->images[enumValue(company->ownerEmotion)], company->getPrimaryColour()));
    ...
    static void draw(Ui::Window& window, Gfx::DrawingContext& drawingCtx)
    {
        ...
        auto image = Gfx::recolour(competitor->images[enumValue(playerCompany->ownerEmotion)], playerCompany->getPrimaryColour());
