...
namespace OpenLoco::Ui::Windows::Cheats
{
    ...
    namespace Vehicles
    {
        ...
        static constexpr auto _widgets = makeWidgets(
            ...
            Widgets::Checkbox({ 25, 130 }, { kWindowSize.width - 20, 12 }, WindowColour::secondary, StringIds::allow_building_locked_vehicles, StringIds::tooltip_build_locked_vehicles),
