...
namespace OpenLoco::Ui::Windows::MapWindow
{
    ...
    static constexpr auto widgets = makeWidgets(
        ...
        makeWidget({ 3, 15 }, { 31, 27 }, WidgetType::wt_6, WindowColour::secondary, ImageIds::withRemap(ImageIds::tab), StringIds::tab_map_overall),
        makeWidget({ 34, 15 }, { 31, 27 }, WidgetType::wt_6, WindowColour::secondary, ImageIds::withRemap(ImageIds::tab), StringIds::tab_map_vehicles),
        makeWidget({ 65, 15 }, { 31, 27 }, WidgetType::wt_6, WindowColour::secondary, ImageIds::withRemap(ImageIds::tab), StringIds::tab_map_industries),
        makeWidget({ 96, 15 }, { 31, 27 }, WidgetType::wt_6, WindowColour::secondary, ImageIds::withRemap(ImageIds::tab), StringIds::tab_map_routes),
        makeWidget({ 158, 15 }, { 31, 27 }, WidgetType::wt_6, WindowColour::secondary, ImageIds::withRemap(ImageIds::tab), StringIds::tab_map_ownership),
