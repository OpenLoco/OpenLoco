...
namespace OpenLoco::Ui::Windows
{
    ...
    namespace Construction
    {
        ...
        void setToTrackExtra(World::TrackElement* track, const uint8_t bh, const World::Pos2 pos);
        void setToRoadExtra(World::RoadElement* track, const uint8_t bh, const World::Pos2 pos);
        void sub_4A6FAC();
