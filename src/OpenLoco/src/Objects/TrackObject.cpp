...
namespace OpenLoco
{
    ...
    void TrackObject::drawPreviewImage(Gfx::RenderTarget& rt, const int16_t x, const int16_t y) const
    {
        ...
        drawingCtx.drawImage(&rt, x, y, colourImage + TrackObj::ImageIds::Style0::kStraight0SleeperNE);
        drawingCtx.drawImage(&rt, x, y, colourImage + TrackObj::ImageIds::Style0::kStraight0RailNE);
    }
    ...
    bool TrackObject::validate() const
    {
        ...
        if (hasPieceFlags(World::Track::TrackPieceFlags::diagonal | World::Track::TrackPieceFlags::largeCurve)
            && hasPieceFlags(World::Track::TrackPieceFlags::oneSided | World::Track::TrackPieceFlags::verySmallCurve))
        {
            return false;
        }
        if (numBridges > 7)
