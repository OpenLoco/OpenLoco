...
namespace OpenLoco
{
    ...
    {
        auto imageId = (closingAnimationFrames + 1) * 8;
        auto frameCount = (closedAnimationFrames - 1);
        auto animationFrame = frameCount & (ScenarioManager::getScenarioTicks() >> closedAnimationSpeed);
