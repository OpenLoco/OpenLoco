...
#pragma pack(push, 1)
    ...
    struct GameState
    {
        ...
        uint16_t recordType[3];                                                        // 0x000436 (0x0052624E)
        uint8_t recordCompany[4];                                                      // 0x00043C (0x00526254)
        uint32_t recordValue[3];                                                       // 0x000440 (0x00526258)
        ...
        Message messages[S5::Limits::maxMessages];                                     // 0x0013BA (0x005271D2)
        ...
        Company companies[S5::Limits::maxCompanies];                                   // 0x00B96C (0x00531784)
        Town towns[S5::Limits::maxTowns];                                              // 0x092444 (0x005B825C)
        Industry industries[S5::Limits::maxIndustries];                                // 0x09E744 (0x005C455C)
        Station stations[S5::Limits::maxStations];                                     // 0x0C10C4 (0x005E6EDC)
