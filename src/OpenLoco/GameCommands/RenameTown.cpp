...
namespace OpenLoco::GameCommands
{
     ...
     */
    static uint32_t renameTown(const uint8_t flags, town_id_t townId, int16_t index, uint32_t buffer0, uint32_t buffer1, uint32_t buffer2)
    {
