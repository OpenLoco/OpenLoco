...
#pragma pack(pop)
    ...
    static void playSound(sound_id id, Map::map_pos3 loc, int32_t volume, int32_t pan, int32_t frequency);
    ...
    void playSound(sound_id id, Map::map_pos3 loc, int32_t volume, int32_t pan, int32_t frequency)
    {
