...
#pragma pack(push, 1)
    struct GameState
    {
        ...
        uint32_t var_1A0;                                                      // 0x0001A0 (0x00525FB8)
        ...
        uint8_t var_1AF;                                                       // 0x0001AF (0x00525FC7)
        uint8_t var_1B0;                                                       // 0x0001B0 (0x00525FC8)
        uint8_t var_1B1;                                                       // 0x0001B1 (0x00525FC9)
        uint8_t var_1B2;                                                       // 0x0001B2 (0x00525FCA)
        uint8_t var_1B3;                                                       // 0x0001B3 (0x00525FCB)
        uint32_t var_1B4;                                                      // 0x0001B4 (0x00525FCC)
        uint32_t var_1B8;                                                      // 0x0001B8 (0x00525FD0)
        ...
        uint16_t var_436[3];                                                   // 0x000436 (0x0052624E)
        uint8_t var_43C[4];                                                    // 0x00043C (0x00526254)
        uint32_t var_440[3];                                                   // 0x000440 (0x00526258)
