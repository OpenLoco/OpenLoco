...
namespace OpenLoco::Ui::Dropdown
{
    ...
    namespace common
    {
        ...
        static void open(Gfx::point_t origin, Gfx::ui_size_t size, Colour_t colour)
        {
            ...
            Input::state(Input::InputState::dropdownActive);
        }
        ...
        static void setColourAndInputFlags(Colour_t& colour, uint8_t& flags)
        {
            ...
            Input::resetFlag(Input::InputFlags::flag1);
            Input::resetFlag(Input::InputFlags::flag2);

            if (flags & (1 << 7))
            {
                Input::setFlag(Input::InputFlags::flag1);
            }
    ...
    void showBelow(window* window, widget_index widgetIndex, size_t count, int8_t itemHeight, uint8_t flags)
    {
        ...
        if (Input::state() != Input::InputState::widgetPressed || Input::hasFlag(Input::InputFlags::widgetPressed))
        {
