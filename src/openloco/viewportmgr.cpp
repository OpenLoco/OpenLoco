...
namespace openloco::ui::viewportmgr
{
    ...
    loco_global<viewport * [max_viewports], 0x0113D820> _viewport_pointers;
    ...
    void init()
    {
        ...
        _viewport_pointers[0] = nullptr;
    }

    std::array<viewport*, max_viewports> viewports()
    {
        auto arr = (std::array<viewport*, max_viewports>*)_viewport_pointers.get();
        return *arr;
    }
