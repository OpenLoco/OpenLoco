...
#define common_options_widgets(window_size, window_caption_id)                                                                                              \
    ...
    namespace display
    {
        ...
        static widget_t _widgets[] = {
            ...
            make_widget({ 380, 50 }, { 11, 10 }, widget_type::wt_11, 1, string_ids::dropdown),
            make_widget({ 235, 64 }, { 156, 12 }, widget_type::wt_18, 1, string_ids::display_resolution_label_format),
            make_widget({ 380, 65 }, { 11, 10 }, widget_type::wt_11, 1, string_ids::dropdown),
            ...
            make_widget({ 380, 134 }, { 11, 10 }, widget_type::wt_11, 1, string_ids::dropdown, string_ids::vehicles_min_scale_tip),
            make_widget({ 235, 148 }, { 156, 12 }, widget_type::wt_18, 1, string_ids::empty, string_ids::station_names_min_scale_tip),
            make_widget({ 380, 149 }, { 11, 10 }, widget_type::wt_11, 1, string_ids::dropdown, string_ids::station_names_min_scale_tip),
            make_widget({ 235, 163 }, { 156, 12 }, widget_type::wt_18, 1, string_ids::empty),
            make_widget({ 380, 164 }, { 11, 10 }, widget_type::wt_11, 1, string_ids::dropdown),
            widget_end(),
        };
