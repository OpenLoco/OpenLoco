...
TEST(NumericTest, rol)
{
    ...
    EXPECT_EQ(Numerics::rol(0u, 4), 0u);
    EXPECT_EQ(Numerics::rol(0b1u, 0), 1u);
    EXPECT_EQ(Numerics::rol(0b0010u, 1), 0b0100u);
    EXPECT_EQ(Numerics::rol(0b0010u, 2), 0b1000u);
    EXPECT_EQ(Numerics::rol(0b0101'0101'0101'0101u, 1), 0b1010'1010'1010'1010u);

    // Rollsover from 32 to 0.
    EXPECT_EQ(Numerics::rol(0b0101'0101'0101'0101u, 32), 0b0101'0101'0101'0101u);
    EXPECT_EQ(Numerics::rol(0b0101'0101'0101'0101u, 33), 0b1010'1010'1010'1010u);

    EXPECT_EQ(Numerics::rol(1ULL, 62), 1ULL << 62);
}
...
TEST(NumericTest, ror)
{
    ...
    EXPECT_EQ(Numerics::ror(0u, 4), 0);
    EXPECT_EQ(Numerics::ror(0b1u, 0), 1);
    EXPECT_EQ(Numerics::ror(0b00000010u, 1), 1);
    EXPECT_EQ(Numerics::ror(0b00000010u, 2), 1u << 31);
    EXPECT_EQ(Numerics::ror(0b0101'0101'0101'0101'0101'0101'0101'0101u, 1), 0b1010'1010'1010'1010'1010'1010'1010'1010u);

    // Rollsover from 32 to 0.
    EXPECT_EQ(Numerics::ror(0b0101'0101'0101'0101'0101'0101'0101'0101u, 32), 0b0101'0101'0101'0101'0101'0101'0101'0101u);
    EXPECT_EQ(Numerics::ror(0b0101'0101'0101'0101'0101'0101'0101'0101u, 33), 0b1010'1010'1010'1010'1010'1010'1010'1010u);

    EXPECT_EQ(Numerics::ror(1ULL << 62, 62), 1u);
}
