...
namespace OpenLoco::StringIds
{
    ...
    constexpr string_id cheat_year = 2229;
    constexpr string_id cheat_month = 2230;
    constexpr string_id cheat_day = 2231;
    constexpr string_id cheat_date_change_apply = 2232;
    constexpr string_id cheat_year_value = 2233;
    constexpr string_id cheat_month_value = 2234;
    constexpr string_id cheat_day_value = 2235;
}
